...
- HM3D 场景数据：`$STRIVE_DATA_ROOT/scene_datasets/hm3d_v0.2`。
- HM3D ObjectNav 回合数据：`$STRIVE_DATA_ROOT/objectnav_hm3d_v2/val/val.json.gz` 或 `$STRIVE_DATA_ROOT/objectgoal_hm3d/val/val.json.gz`。
