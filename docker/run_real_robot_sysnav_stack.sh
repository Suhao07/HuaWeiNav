...
for name in \
  ...
  VLN_LVLM_BASE_URL VLN_LVLM_API_KEY VLN_LVLM_MODEL \
  VLN_LVLM_TIMEOUT_S VLN_LVLM_TRANSPORT_RETRIES VLN_LVLM_PARSE_RETRIES \
  STRIVE_LVLM_BASE_URL STRIVE_LVLM_API_KEY STRIVE_LVLM_MODEL \
  STRIVE_LVLM_TIMEOUT_S STRIVE_LVLM_TRANSPORT_RETRIES STRIVE_LVLM_PARSE_RETRIES \
  ...
  START_WAYPOINT_ADAPTER WAYPOINT_ADAPTER_CONFIG WAYPOINT_ADAPTER_INPUT_TOPIC \
  WAYPOINT_ADAPTER_OUTPUT_TOPIC WAYPOINT_ADAPTER_ODOM_TOPIC WAYPOINT_ADAPTER_OUTPUT_ENABLED \
