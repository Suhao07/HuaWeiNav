...
runtime_args() {
  ...
  append_runtime_arg RUNTIME_ARGS "odom_topic" "${STRIVE_ODOM_TOPIC:-${POSE_TOPIC}}"
  append_runtime_arg RUNTIME_ARGS "world_frame" "${STRIVE_WORLD_FRAME:-${WORLD_FRAME}}"
...
adapter_args() {
  ...
  append_runtime_arg WAYPOINT_ADAPTER_ARGS "odom_topic" "${WAYPOINT_ADAPTER_ODOM_TOPIC:-${POSE_TOPIC}}"
